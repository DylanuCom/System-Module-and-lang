        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent nav-legacy nav-compact" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    @if ($menus['menu_count'] == 1)
                        @foreach ($menus['menus'] as $menu)
                            @if ($i == 1)
                                ...
                                @endphp
                                @canany($perm)
                                    <li class="nav-header ml-2">@lang('admin.Module')</li>
                                @endcanany
                            @endif
                            @can($menu['permission'])
                                <li class="nav-item">
                ...
                @canany(['read user', 'read role', 'read permission'])
                    <li class="nav-header ml-2">@lang('admin.ACCESS')</li>
                @endcanany
                @can('read user')
                    <li class="nav-item">
